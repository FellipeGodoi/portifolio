...
import Git from "../../imagens/outrosIcones/Git.png";
import ReactJs from "../../imagens/outrosIcones/React.png";
import Angular from "../../imagens/outrosIcones/image 9.png";
    ...
    return (
        <div>
            <div className="d-flex justify-content-center flex-column ">
                <span className="fs-4 fw-bold mb-3">Tecnologias atuais</span>
                <div className="d-flex flex-wrap justify-content-between">
                    ...
                    <div className="col-12 col-sm-6 col-md-4 col-lg-2 mb-4">
                        <IconePersonalizado imagemUrl={Git} titulo={"Git"} dominio={3} />
                    </div>
                    <div className="col-12 col-sm-6 col-md-4 col-lg-2 mb-4">
            ...
            <div>
                <div className="d-flex justify-content-center flex-column">
                    <span className="fs-4 fw-bold mb-3 pt-5">Futuramente</span>
                    <div className="d-flex flex-wrap justify-content-between">
                        <div className="col-12 col-sm-6 col-md-4 col-lg-2 mb-4">
                        ...
                        <div className="col-12 col-sm-6 col-md-4 col-lg-2 mb-4">
                            <IconePersonalizado imagemUrl={Angular} titulo={"Angular"} dominio={1} />
                        </div>
                        <div className="col-12 col-sm-6 col-md-4 col-lg-2 mb-4">
